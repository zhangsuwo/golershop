...
CREATE TABLE `account_user_tag_group`  (
  ...
  `create_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '添加时间',
...
-- ----------------------------
INSERT INTO `account_user_tag_group` VALUES (22, '客户级别', 10, b'1', b'0', '2023-09-14 08:22:05', '2001-01-01 01:01:01');
INSERT INTO `account_user_tag_group` VALUES (23, '客户地区', 20, b'1', b'0', '2023-09-14 08:24:12', '2001-01-01 01:01:01');
INSERT INTO `account_user_tag_group` VALUES (24, '购买类型', 30, b'1', b'0', '2023-09-14 08:25:49', '2001-01-01 01:01:01');
...
CREATE TABLE `admin_menu_base`  (
  ...
  `menu_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '最后更新时间',
...
CREATE TABLE `invoicing_stock_bill`  (
  ...
  `stock_bill_modify_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
...
CREATE TABLE `pay_user_exp_history`  (
  ...
  `store_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属店铺',
  `exp_log_date` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '获得经验的日期',
...
CREATE TABLE `pt_product_ask_base`  (
  ...
  `ask_answer_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '回答时间',
...
CREATE TABLE `shop_store_info`  (
  ...
  `store_end_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '有效期截止时间',
...
CREATE TABLE `shop_user_sign`  (
  ...
  `user_id` int(11) UNSIGNED NOT NULL COMMENT '用户编号',
  `sign_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '签到时间',
...
CREATE TABLE `shop_user_voucher`  (
  ...
  `user_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属用户',
  `order_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '订单编号',
  `user_voucher_activetime` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '使用时间',
...
-- ----------------------------
INSERT INTO `sys_config_type` VALUES (1, '站点设置', 1, b'1', b'1', '2023-08-05 15:43:39', '2001-01-01 01:01:01', 1001);
INSERT INTO `sys_config_type` VALUES (2, '上传设置', 50, b'1', b'1', '2023-05-29 08:48:34', '2001-01-01 01:01:01', 1002);
INSERT INTO `sys_config_type` VALUES (3, '过滤词汇', 3, b'1', b'1', '2023-05-28 12:18:42', '2001-01-01 01:01:01', 1003);
INSERT INTO `sys_config_type` VALUES (4, '公众号H5', 4, b'1', b'0', '2023-08-05 16:49:20', '2001-01-01 01:01:01', 8001);
INSERT INTO `sys_config_type` VALUES (5, '搜索设置', 5, b'0', b'1', '2023-08-05 15:47:05', '2001-01-01 01:01:01', 1003);
INSERT INTO `sys_config_type` VALUES (7, '积分设置', 7, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1003);
INSERT INTO `sys_config_type` VALUES (8, '财务设置', 8, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1101);
INSERT INTO `sys_config_type` VALUES (10, '物流设置', 10, b'1', b'0', '2022-11-10 16:53:01', '2001-01-01 01:01:01', 0);
INSERT INTO `sys_config_type` VALUES (11, '互联登录', 11, b'1', b'0', '2022-11-10 16:53:01', '2001-01-01 01:01:01', 0);
INSERT INTO `sys_config_type` VALUES (12, '邮件设置', 12, b'1', b'0', '2022-11-10 16:53:01', '2001-01-01 01:01:01', 0);
INSERT INTO `sys_config_type` VALUES (13, '短信设置', 13, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 7001);
INSERT INTO `sys_config_type` VALUES (14, '推送设置', 14, b'1', b'0', '2022-11-10 16:53:01', '2001-01-01 01:01:01', 0);
INSERT INTO `sys_config_type` VALUES (20, '服务设置', 20, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 6001);
INSERT INTO `sys_config_type` VALUES (21, '功能设置', 21, b'1', b'0', '2023-07-19 15:25:32', '2001-01-01 01:01:01', 0);
INSERT INTO `sys_config_type` VALUES (22, '微信小程序', 4, b'1', b'0', '2023-08-05 16:16:42', '2001-01-01 01:01:01', 8001);
INSERT INTO `sys_config_type` VALUES (23, '开放移动应用', 4, b'1', b'0', '2023-08-05 16:27:46', '2001-01-01 01:01:01', 8001);
INSERT INTO `sys_config_type` VALUES (29, '开放网站应用', 4, b'1', b'0', '2023-08-05 16:27:08', '2001-01-01 01:01:01', 8001);
INSERT INTO `sys_config_type` VALUES (30, '注册协议', 41, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1005);
INSERT INTO `sys_config_type` VALUES (31, '隐私政策', 42, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1005);
INSERT INTO `sys_config_type` VALUES (32, '注销协议', 43, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1005);
INSERT INTO `sys_config_type` VALUES (33, '付费会员协议', 44, b'0', b'1', '2023-10-08 11:54:44', '2001-01-01 01:01:01', 1005);
INSERT INTO `sys_config_type` VALUES (34, '积分协议', 45, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1005);
INSERT INTO `sys_config_type` VALUES (35, '阿里云Oss', 51, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1002);
INSERT INTO `sys_config_type` VALUES (36, '腾讯云Oss', 52, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1002);
INSERT INTO `sys_config_type` VALUES (37, '华为云Oss', 53, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1002);
INSERT INTO `sys_config_type` VALUES (39, '商品设置', 3, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1003);
INSERT INTO `sys_config_type` VALUES (40, '交易设置', 3, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1003);
INSERT INTO `sys_config_type` VALUES (41, '订单流程', 50, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 5001);
INSERT INTO `sys_config_type` VALUES (1401, '支付宝支付', 32, b'1', b'1', '2023-06-29 12:29:22', '2001-01-01 01:01:01', 1004);
INSERT INTO `sys_config_type` VALUES (1403, '微信支付', 31, b'1', b'1', '2023-06-29 12:29:59', '2001-01-01 01:01:01', 1004);
INSERT INTO `sys_config_type` VALUES (1406, '余额支付', 33, b'1', b'1', '2023-06-29 12:30:49', '2001-01-01 01:01:01', 1004);
INSERT INTO `sys_config_type` VALUES (1413, '积分支付', 35, b'1', b'1', '2023-08-05 15:43:32', '2001-01-01 01:01:01', 1004);
INSERT INTO `sys_config_type` VALUES (1422, '线下支付', 34, b'1', b'1', '2023-06-29 12:31:17', '2001-01-01 01:01:01', 1004);
INSERT INTO `sys_config_type` VALUES (1423, '客服类型', 255, b'1', b'0', '2023-08-05 17:00:31', '2001-01-01 01:01:01', 1003);
INSERT INTO `sys_config_type` VALUES (1424, '升级经验值', 255, b'1', b'0', '2023-08-06 07:48:09', '2001-01-01 01:01:01', 1003);
INSERT INTO `sys_config_type` VALUES (1425, '安全设置', 255, b'1', b'0', '2023-09-10 08:42:50', '2001-01-01 01:01:01', 0);
INSERT INTO `sys_config_type` VALUES (1426, '用户管理', 255, b'1', b'0', '2023-10-08 18:01:12', '2001-01-01 01:01:01', 0);
INSERT INTO `sys_config_type` VALUES (1427, '发票设置', 255, b'1', b'0', '2023-10-27 10:14:35', '2001-01-01 01:01:01', 0);
...
CREATE TABLE `sys_lang_standard`  (
  ...
  `time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '时间',
...
INSERT INTO `sys_page_module` VALUES (664, '', 1638151353229, 11791, '', '', '1101', '2001-01-01 01:01:01', 2, 1, '', '{\"banner1\":{\"url\":\"\",\"picimg\":\"https://shopsuite.oss-accelerate.aliyuncs.com/media/user/11791/image/20211231/1640938551514028.png\",\"name\":\"横幅名称\",\"imgSize\":\"1200x120\"},\"module_id\":\"1101\",\"pm_id\":664,\"pm_enable\":true}', 0, '');
...
INSERT INTO `sys_page_module` VALUES (666, '', 1638151353229, 11791, '', '', '1101', '2001-01-01 01:01:01', 8, 1, '', '{\"banner1\":{\"url\":\"\",\"picimg\":\"https:\\/\\/shopsuite.oss-accelerate.aliyuncs.com\\/media\\/user\\/11791\\/image\\/20211231\\/1640953314620031.png\",\"name\":\"横幅名称\",\"imgSize\":\"1200x120\"},\"module_id\":\"1101\",\"pm_id\":\"666\",\"pm_enable\":\"1\"}', 0, '');
...
INSERT INTO `sys_page_module` VALUES (668, '', 1638151353229, 11791, '', '', '1101', '2001-01-01 01:01:01', 6, 1, '', '{\"banner1\":{\"url\":\"/product/lists?category_id=2133\",\"picimg\":\"https://shopsuite.oss-accelerate.aliyuncs.com/media/user/11791/image/20211231/1640955981889073.png\",\"name\":\"横幅名称\",\"imgSize\":\"1200x120\"},\"module_id\":\"1101\",\"pm_id\":668,\"pm_enable\":true}', 0, '');
...
INSERT INTO `sys_page_module` VALUES (671, '', 1638151353229, 11791, '', '', '1101', '2001-01-01 01:01:01', 10, 1, '', '{\"banner1\":{\"url\":\"/product/lists\",\"picimg\":\"https://kuteshop.oss-accelerate.aliyuncs.com/modulithshop/guest/image/plantform/20231107/7475eb913745480ea9a976d3c38c582d.jpg\",\"name\":\"横幅名称\",\"imgSize\":\"1200x120\"},\"module_id\":\"1101\",\"pm_id\":671,\"pm_enable\":true}', 0, '');
INSERT INTO `sys_page_module` VALUES (672, '', 1638151353229, 11791, '', '', '1101', '2001-01-01 01:01:01', 13, 0, '', '{\"banner1\":{\"url\":\"\",\"picimg\":\"https://shopsuite.oss-accelerate.aliyuncs.com/media/user/11791/image/20211231/1640960385108620.png\",\"name\":\"横幅名称\",\"imgSize\":\"1200x120\"},\"module_id\":\"1101\",\"pm_id\":672,\"pm_enable\":false}', 0, '');
...
CREATE TABLE `trade_chain_code`  (
  ...
  `virtual_service_date` date NOT NULL DEFAULT '2001-01-01',
  `virtual_service_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01',
  `user_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户编号',
  `store_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺编号',
...
CREATE TABLE `trade_order_info`  (
  ...
  `payment_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '付款时间',
  ...
  `order_received_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '订单签收时间',
  `chain_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店编号',
  `delivery_type_id` tinyint(4) UNSIGNED NOT NULL DEFAULT 0 COMMENT '配送方式',
  ...
  `order_fx_settlement_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '佣金结算时间',
...
CREATE TABLE `trade_order_return`  (
  ...
  `return_finish_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '退款完成时间',
  ...
  `return_settlement_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '订单结算时间',
  ...
  `return_channel_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '渠道退款时间',
  ...
  `return_financial_confirm_time` timestamp(0) NOT NULL DEFAULT '2001-01-01 01:01:01' COMMENT '退款财务确认时间',
  `subsite_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属分站:0-总站',
